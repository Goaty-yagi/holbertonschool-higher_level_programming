...
class TestTask9(ParentTest):
    ...
    def test_module_doc(self):
        ...
        module = importlib.import_module("9-rectangle")
    ...
    def test_square_return_instance(self):

        module = importlib.import_module("9-rectangle")
        instance = module.Rectangle.square(90)

        self.assertTrue(isinstance(instance, module.Rectangle))
