...
**File:** [16-shows_by_genre.sql](https://github.com/Goaty-yagi/holbertonschool-higher_level_programming/blob/main/SQL_more_queries/16-shows_by_genre.sql)<br>
**Description:** Write a script that lists all shows, and all genres linked to that show, from the database hbtn_0d_tvshows.<br>
**Requirements:** <br>
